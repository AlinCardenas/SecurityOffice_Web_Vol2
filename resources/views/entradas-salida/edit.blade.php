...
<section class="content container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('entradas.update', $entradasSalida) }}" role="form"
                        ...
                        <div class="card w-75">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    {{ Form::label('entrada:') }}
                                    <input type="time" name="entrada" id="entrada" class="form-control" value="{{$entradasSalida->entrada}}">
                                </div><br>
                                <div class="form-group">
                                    {{ Form::label('salida:') }}
                                    <input type="time" name="salida" id="salida" class="form-control" value="{{$entradasSalida->salida}}">
                                </div><br>
                                <div class="form-group">
                                    <label for="">Fecha:</label>
                                    <input type="date" name="fecha" id="fecha" class="form-control" value="{{$entradasSalida->fecha}}">
                                </div><br>
                                <div class="form-group">
